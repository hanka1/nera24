const proposition_info = {
    cz: `
        ...
        <div class="heading1">O závodu:</div>
        ...
        <div class="heading1">Základní informace:</div>
        ...
        <div class="heading1">Zázemí a vybavení:</div>
        <ul style="list-style-type: disc; padding-left: 20px;">
        ...
        <div class="heading1">Kategorie Nera 24:</div>
        ...
        <div class="heading2">Startovné 24h zaplacené do 31.7.2025 <span style="color: rgb(13, 119, 189);">(po 31.7.2025)</span></div>
        <ul style="list-style-type: disc; padding-left: 20px;">
        ...
        <div class="heading2">Startovné 12h zaplacené do 31.7.2025 <span style="color: rgb(13, 119, 189);">(po 31.7.2025)</span></div>
        <ul style="list-style-type: disc; padding-left: 20px;">
    ...
    en: `
        ...
        <div class="heading1">About the race:</div>
        ...
        <div class="heading1">Basic information:</div>
        <ul style="list-style-type: disc; padding-left: 20px;">
        ...
        <div class="heading1">Facilities and equipment:</div>
        <ul style="list-style-type: disc; padding-left: 20px;">
        ...
        <div class="heading1">Nera 24 Category:</div>
        ...
        <div class="heading2">24h entry fee paid by July 31, 2025 <span style="color: rgb(13, 119, 189);">(after July 31, 2025)</span></div>
        <ul style="list-style-type: disc; padding-left: 20px;">
        ...
        <div class="heading2">12h entry fee paid by July 31, 2025 <span style="color: rgb(13, 119, 189);">(after July 31, 2025)</span></div>
        <ul style="list-style-type: disc; padding-left: 20px;">
